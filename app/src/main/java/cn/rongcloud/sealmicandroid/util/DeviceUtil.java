...
public class DeviceUtil {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                SealMicApp.getApplication().getContentResolver(),
    ...
    private static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) SealMicApp.getApplication().getSystemService(WIFI_SERVICE);
        if (manager == null) {
            return false;
        }
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) SealMicApp.getApplication()
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) SealMicApp.getApplication().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(SealMicApp.getApplication().getPackageManager()) == null;
        if (checkDial) {
            return true;
        }
        ;
...
//        if (checkDebuggerConnected) return true;
    ...
    public static String getUniqueDeviceId(String prefix, boolean useCache) {
        ...
        if (udid == null) {
            synchronized (DeviceUtil.class) {
                if (udid == null) {
                    final String id = (String) SPUtil.get(SealMicApp.getApplication(), KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId = (String) SPUtil.get(SealMicApp.getApplication(), KEY_UDID, "");
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        SPUtil.put(SealMicApp.getApplication(), KEY_UDID, udid);
        return udid;
    }
